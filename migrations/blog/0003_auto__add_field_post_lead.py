...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.lead'
        db.add_column('blog_post', 'lead', self.gf('django.db.models.fields.TextField')(default=None, max_length=300, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.lead'
        db.delete_column('blog_post', 'lead')
    ...
    models = {
        ...
        'blog.post': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lead': ('django.db.models.fields.TextField', [], {'default': 'None', 'max_length': '300', 'null': 'True', 'blank': 'True'}),
