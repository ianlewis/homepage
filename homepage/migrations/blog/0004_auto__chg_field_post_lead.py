...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.lead'
        db.alter_column('blog_post', 'lead', self.gf('django.db.models.fields.TextField')(max_length=600, null=True))


    def backwards(self, orm):
        
        # Changing field 'Post.lead'
        db.alter_column('blog_post', 'lead', self.gf('django.db.models.fields.TextField')(max_length=300, null=True))
