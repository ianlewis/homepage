...
class Post(models.Model):
    ...
    lead = models.TextField(
        u"lead", blank=True, null=True, default=None, max_length=600
    )
    content = models.TextField(u"content")
    markup_type = models.CharField(
        max_length=10,
        choices=(("md", "Markdown"), ("rst", "reStructuredText"), ("html", "HTML"),),
        default="md",
    )
    locale = models.CharField(
        u"locale", max_length=20, choices=BLOG_LOCALES, default="en", db_index=True
    )
    ...
    pub_date = models.DateTimeField(
        u"published date", default=datetime.now, db_index=True
    )
    ...
    def get_absolute_url(self):
        return ("blog_detail", (), {"locale": self.locale, "slug": self.slug})

    @property
    def lang(self):
        return {"en": "en", "jp": "ja"}.get(self.locale, "en")
